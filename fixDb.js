  ...
  try {
    ...
    if (res1.rowCount > 0) {
      ...
      const res3 = await pool.query(`
        ...
        VALUES 
        ('Pembangunan Jalan Mentangor', 'pembangunan-jalan', 'pembangunan', 'Sukses pembangunan.', 'https://placehold.co/600x400', true, 0),
        ('Vaksinasi Posyandu', 'vaksinasi', 'kesehatan', 'Sukses posyandu.', 'https://placehold.co/600x400', true, 0)
        RETURNING id
      `);
